...
import { Tag, Layers, Barcode, Sparkles, ChevronRight, ShoppingCart, Star, Zap, Search, Camera } from 'lucide-react';
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 dark:from-purple-400 dark:via-pink-500 dark:to-red-500">
              {searchType === 'image' ? 'Visual Search Results' : 'Search Results'}
            </h1>
          </div>
          ...
          {searchQuery && (
            <div className="mb-6">
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-2">
                {searchType === 'image' ? 'Similar products found for your image' : `Search results for "${searchQuery}"`}
              </p>
                      ...
                      >
                        ...
                        <div className={`h-full rounded-2xl overflow-hidden transition-all duration-300 group-hover:border-pink-500/30 ${getRandomGradient()} border border-gray-200/70 dark:border-gray-800/50`}>
                          <div className="relative h-60 overflow-hidden">
                            ...
                            {searchType === 'image' && similarityPercentage !== 'N/A' && (
                          ...
                          <div className="p-5">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-xs">
                              ...
                              <div className="flex items-center gap-1 text-pink-600 dark:text-pink-400">
                                <Sparkles size={12} />
                                <span>{searchType === 'image' ? `Match: ${similarityPercentage}%` : 'Text Search'}</span>
                              </div>
                            </div>
